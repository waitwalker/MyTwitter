...
class MTTTabTweetView: MTTTabBaseView {

    let disposeBag = DisposeBag()
    
    var homeModels:[MTTHomeModel] = []
    
    let reusedTweetId:String = "reusedTweetId"
    ...
    override init(frame: CGRect) 
    {
        ...
        self.tableView.register(MTTHomeCell.self, forCellReuseIdentifier: reusedTweetId)
    }
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell 
    {
        ...
        {
            var homeCell = tableView.dequeueReusableCell(withIdentifier: reusedTweetId) as? MTTHomeCell
            if homeCell == nil
            {
                homeCell = MTTHomeCell(style: UITableViewCellStyle.default, reuseIdentifier: reusedTweetId)
            }
