...
class MTTTabTweetAndReplyView: MTTTabBaseView {
    ...
    let reusedTweetAndReplyId:String = "reusedTweetAndReplyId"
    ...
    override init(frame: CGRect) 
    {
        ...
        self.tableView.register(MTTHomeCell.self, forCellReuseIdentifier: reusedTweetAndReplyId)
    }
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell 
    {
        ...
        {
            var homeCell = tableView.dequeueReusableCell(withIdentifier: reusedTweetAndReplyId) as? MTTHomeCell
            if homeCell == nil
            {
                homeCell = MTTHomeCell(style: UITableViewCellStyle.default, reuseIdentifier: reusedTweetAndReplyId)
            }
